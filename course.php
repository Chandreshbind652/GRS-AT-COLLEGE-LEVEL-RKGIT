...
<div class="main--content">
   ...
   <div class="payment-card m-3" style=" background-color:lightcoral;">
    ...
    <form action="coursecode.php" method="post">
    <table cellpadding="20px">
        <tr>
          <td class="session1"><input type="text" name="course" placeholder="Add Course " style="text-align:center; width:250px; height:30px; border-radius:20px;"/></td></tr>
        <tr>
